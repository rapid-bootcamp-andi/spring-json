...
```
cd existing_repo
git remote add origin https://gitlab.com/rapid-bootcamp/spring-json.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rapid-bootcamp/spring-json/-/settings/integrations)
